...
$(document).ready(function () {
  ...
  function submitUserData() {
    ...
    let input_data_arr = [
      ...
      document.getElementById("hol_start_date").value,
      document.getElementById("hol_end_date").value,
      document.getElementById('editID').value,
    ];
  
    fetch("controller/holiday_eventHandler.php", {
      method: "POST",
      headers: {
