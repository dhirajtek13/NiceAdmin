...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($username == '' || $email == '' || $password == '') {
    $showError = '';
    if ($username == '') {
      $showError .= "Please enter username.<br>";
    }
    if ($email == '') {
      $showError .= "Please enter email.<br>";
    }
    if ($password == '') {
      $showError .= "Please enter password.<br>";
    }
  } else {
                    ...
                    <form class="row g-3" method="post" action="add-user.php">
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          ...
                          <label for="floatingEmail">Your Email <span class="required_mark">*</span></label>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-floating">
                          <input name="password" type="password" class="form-control" id="floatingPassword" placeholder="Password" required>
                          <label for="floatingPassword">Password <span class="required_mark">*</span></label>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-floating">
