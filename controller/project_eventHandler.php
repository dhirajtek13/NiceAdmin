...
if ($jsonObj->request_type == 'addEdit') {
    ...
    $renewal_date = !empty($user_data[6]) ? $user_data[6] : '';
    $customer_name = !empty($user_data[7]) ? $user_data[7] : '';
    $planned_billing = !empty($user_data[8]) ? $user_data[8] : '';
    $actual_billing = !empty($user_data[9]) ? $user_data[9] : '';
    ...
    if ($project_name && $project_code) {
        ...
        echo json_encode(['error' => 'Project Name and ID both requied!']);
    }
